 ...
 *
 * Pipedream Connect has been removed from FlowOS Reach as of 2026-05-24.
 *
 * Migration:
...
export default function handler() {
  return new Response(
    JSON.stringify({
      error: "Pipedream Connect has been removed from FlowOS Reach. Social platforms now use /api/zernio.",
