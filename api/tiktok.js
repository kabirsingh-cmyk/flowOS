// FlowOS Reach — TikTok posting via Zernio
// Thin proxy to /api/zernio. Zernio handles TikTok OAuth + publishing.
...
export default async function handler(req) {
  ...
  if (body.action === "publish_now") return forwardToZernio(req, { ...body, platform: "tiktok" });
