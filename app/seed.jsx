...
const SEED = {
  ...
  inbox: [
    { id: "i1", source: "Instagram · comment", author: "@aanya.j",     risk: "low",    text: "wait is the rose & cardamom soap back in stock?",   draft: "Rose & Cardamom is restocking next Tuesday — the tribe gets first access. Drop your email and we'll send a reminder ☁️", category: "product question", status: "open" },
    { id: "i2", source: "Instagram · DM",      author: "@beautysoothes", risk: "medium", text: "Would love to send our kit to your founder for a feature — what's the best route?", draft: "Thanks for reaching out — passing to our partnerships lead, who'll reply within 2 days.", category: "partnerships", status: "open" },
    { id: "i3", source: "Email · reply",       author: "noor.a@vogue.in",   risk: "high", text: "Following up for a feature on heritage Indian beauty brands. Deadline Friday.", draft: "— routing to press contact —", category: "press", status: "open" },
    { id: "i4", source: "TikTok · comment",    author: "@morning.warmth", risk: "low",    text: "does the night serum smell strong? I'm sensitive to scent",   draft: "It's quiet — sandalwood and a whisper of vetiver. Most sensitive skin loves it. Sample set if you'd rather try first.", category: "product question", status: "open" },
    { id: "i5", source: "Klaviyo · reply",     author: "Maya R.",            risk: "medium", text: "I had a bad experience with returns last month — still waiting.", draft: "— needs human — ", category: "service", status: "open" },
  ],
  assets: [
